defmodule BroadwayViewerWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(BroadwayViewerWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(BroadwayViewerWeb.Gettext, "errors", msg, opts)
    end
  end
